...
\begin{box-note}
\footnotesize Example of \mintinline{cpp}{std::for_each} algorithm with a custom function object, calculating the number of elements and their sum.
\tcblower
\cppfile{code_examples/introduction/history_cc98_code.h}
\end{box-note}

\begin{box-note}
\footnotesize Example of \mintinline{cpp}{std::for_each} algorithm with a capturing lambda, calculating the number of elements and their sum.
\tcblower
...
Finally, the \CC20 standard introduced a major re-design in the form of ranges and views.
