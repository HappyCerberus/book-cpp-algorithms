...
The \cpp{std::lower_bound} and \cpp{std::upper_bound} algorithms offer boundary search with logarithmic complexity.
...
\begin{box-note}
\footnotesize Example of using \cpp{std::lower_bound} and \cpp{std::upper_bound} to divide a sorted range into three parts: lower than bottom threshold, in between bottom and upper threshold and higher than upper threshold.
\tcblower
