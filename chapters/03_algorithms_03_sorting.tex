\section{Sorting}
Before we talk about sorting, we need to discuss what the standard requires for types to be comparable—specifically, the strict weak ordering required by sorting algorithms.

Implementing a strict weak ordering for a custom type at minimum requires providing an overload of operator< with the following behaviour:
